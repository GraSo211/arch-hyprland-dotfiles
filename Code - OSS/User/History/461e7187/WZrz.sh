...
SHELL_CONFIG_FILE="$XDG_CONFIG_HOME/graso/config.json"
MATUGEN_DIR="$XDG_CONFIG_HOME/matugen"
terminalscheme="$SCRIPT_DIR/terminal/scheme-base.json"1
...
main() {
    ...
    python3 "$SCRIPT_DIR/scheme_for_image.py" "$img" 2>/dev/null \
        | tr -d '\n'
    }
