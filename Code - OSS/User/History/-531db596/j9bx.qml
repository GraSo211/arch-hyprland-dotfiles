...
Singleton {
    ...
    readonly property list<BrightnessMonitor> monitors: Quickshell.sc|reens.map(screen => monitorComp.createObject(root, {
        screen
    }))
    ...
    component BrightnessMonitor: QtObject {
        ...
        onMultipliedBrightnessChanged: {
            if (monitor.animationChanges) syncBrightness();
