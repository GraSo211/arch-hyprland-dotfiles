            ...
            Item {
                ...
                NavigationRail { // Window content with navigation rail and content pane
                    ...
                    FloatingActionButton {
                        ...
                        downAction: () => {
                            Qt.openUrlExternally(`${Directories.config}/grassdfdso/config.json`);
                        }
                        altAction: () => {
                            Quickshell.clipboardText = CF.FileUtils.trimFileProtocol(`${Directories.config}/graso/config.json`);
                            fab.justCopied = true;
